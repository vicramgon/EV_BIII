...
#############
'''
from ASCEVBIII import EOP1, MOEAD
...
for seed in [i+1 for i in range(9)]+[99]:
    ...
    data2 = np.genfromtxt(f"NSGAII/EVAL10000/P{N}G{G}/zdt3_final_popp{N}g{G}_seed{'0' + str(seed)}.out", delimiter='\t')
...
'''
######################################
# PROOF 1.2: MOEA/D + EOP1 (N40G250) #
######################################
'''

# MOEA PARAMETERS
N =40; G =250; T=6; eop=EOP1
# Color gradient for plots
colors = plt.get_cmap('jet',G)
...
'''
######################################
# PROOF 1.3: MOEA/D + EOP1 (N200G50) #
######################################
'''

# MOEA PARAMETERS
N =303; G = 33; T=45; eop=EOP1
...
'''
# Pi = (N, G, T)
PROOFS = [(100,100,15), (40,250,6), (200,50,30)]; eop=EOP1
