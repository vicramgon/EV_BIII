    ...
    do
        for n in 40 100 200
            do
            	...
            	for i in {1..9} 99
		    do
			 cat ../MOEA_D_${eop}/ZDT3/EVAL10000/N${n}_G${g}_T$((15*$n/100))/outputs/s${i}_nds.out >> zdt3_all_seeds_nds.out
		    done
            done
    done
    ...
    do
        ...
        for n in 40 100 200
            do
            	...
            	for i in {1..9} 99
		    do
			 cat ../MOEA_D_${eop}/ZDT3/EVAL10000/N${n}_G${g}_T$((15*$n/100))/outputs/s${i}_nds.out > processData.out
...
python ../NDSMETRICSPROCESS_10000EV.py
