    ...
    do
        for n in 40 100 200
            do
            	...
            	for i in {1..9} 99
		    do
			 cat ../${eop}/CF6_16D/EVAL10000/N${n}_G${g}_T$((12*$n/100))/outputs/s${i}_gen$(($g-1)).out >> cf616d_all_seeds_finalgen.out
		    done
            done
    done
...
for n in 40 100 200
    do
    	...
    	for i in {1..9} 99
	    do
		 tail -${n} ../NSGAII/CF6_16D/EVAL10000/P${n}G${g}/cf6_16d_all_popmp${n}g${g}_seed0${i}.out >> cf616d_all_seeds_finalgen.out
	    done
    done
    ...
    do
        ...
        for n in 40 100 200
            do
            	...
            	for i in {1..9} 99
		    do
			 cat ../${eop}/CF6_16D/EVAL10000/N${n}_G${g}_T$((12*$n/100))/outputs/s${i}_gen$(($g-1)).out > processData.out
...
for n in 40 100 200
    do
    	...
    	for i in {1..9} 99
	    do
		 tail -${n} ../NSGAII/CF6_16D/EVAL10000/P${n}G${g}/cf6_16d_all_popmp${n}g${g}_seed0${i}.out > processData.out
		 echo -e "1\n0\n2\nprocessData.out\n${n}\n1\n0\n$hvrefx\n$hvrefy" > processData.in
		 ./metrics  < processData.in
		 hvi=`cut -f2 hypervol.out`
		 spci=`cut -f2 spacing.out`
...
python ../FGENMETRICSPROCESS_HV_SPC_10000EV_CF6_16D.py
