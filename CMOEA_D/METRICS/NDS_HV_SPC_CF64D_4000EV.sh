    ...
    do
        for n in 40 80 100
            do
            	...
            	for i in {1..9} 99
		    do
			 cat ../${eop}/CF6_4D/EVAL4000/N${n}_G${g}_T$((10*$n/100))/outputs/s${i}_nds.out >> cf64d_all_seeds_nds.out
		    done
            done
    done
    ...
    do
        ...
        for n in 40 80 100
            do
            	...
            	for i in {1..9} 99
		    do
			 cat ../${eop}/CF6_4D/EVAL4000/N${n}_G${g}_T$((10*$n/100))/outputs/s${i}_nds.out > processData.out
...
python ../NDS_METRICSPROCESS_HV_SPC_4000EV_CF6_4D.py
