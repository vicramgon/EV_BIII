    ...
    do
        for n in 40 80 100
            do
            	...
            	for i in {1..9} 99
		    do
			 cat ../MOEA_D_${eop}/ZDT3/EVAL4000/N${n}_G${g}_T$((15*$n/100))/outputs/s${i}_gen$(($g-1)).out >> zdt3_all_seeds_finalgen.out
		    done
            done
    done
for n in 40 80 100
    do
    	...
    	for i in {1..9} 99
	    do
		 tail -${n} ../NSGAII/ZDT3/EVAL4000/P${n}G${g}/zdt3_all_popmp${n}g${g}_seed0${i}.out >> zdt3_all_seeds_finalgen.out
	    done
    done
    ...
    do
        ...
        for n in 40 80 100
            do
            	...
            	for i in {1..9} 99
		    do
			 cat ../MOEA_D_${eop}/ZDT3/EVAL4000/N${n}_G${g}_T$((15*$n/100))/outputs/s${i}_gen$(($g-1)).out > processData.out
...
for n in 40 80 100
    do
    	...
    	for i in {1..9} 99
	    do
		 tail -$n ../NSGAII/ZDT3/EVAL4000/P${n}G${g}/zdt3_all_popmp${n}g${g}_seed0${i}.out > processData.out
		 echo -e "1\n0\n2\nprocessData.out\n${n}\n1\n0\n$hvrefx\n$hvrefy" > processData.in
		 ./metrics  < processData.in
		 hvi=`cut -f2 hypervol.out`
		 spci=`cut -f2 spacing.out`
