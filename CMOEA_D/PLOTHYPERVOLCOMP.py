...
plt.title(f'Hyervolume Comp. {problem} {ALG1} N{N1} G{G1} vs {ALG2} N{N2} G{G2}\n', fontsize=10)
...
plt.savefig(f'../METRICS_PLOTS/{problem}/Hypervol_COMP_{problem}_{ALG1}N{N1}G{G1}_{ALG2}N{N2}G{G2}.png', dpi=600)
plt.clf()