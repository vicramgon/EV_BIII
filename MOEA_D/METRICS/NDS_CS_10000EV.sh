	...
	for eop2 in EOP1 EOP2 EOP3
		...
		for n in 40 100 200
		    do
		    	...
		    	for i in {1..9} 99
			    do
				 cat ../MOEA_D_${eop1}/ZDT3/EVAL10000/N${n}_G${g}_T$((15*$n/100))/outputs/s${i}_nds.out > processData1.out
				 lines1=`wc -l < processData1.out`
				 cat ../MOEA_D_${eop2}/ZDT3/EVAL10000/N${n}_G${g}_T$((15*$n/100))/outputs/s${i}_nds.out > processData2.out
